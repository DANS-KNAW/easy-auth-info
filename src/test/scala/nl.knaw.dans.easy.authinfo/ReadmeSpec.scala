...
class ReadmeSpec extends AnyFlatSpec with Matchers with CustomMatchers {
  ...
  "options in help info" should "be part of manual" in {
  ...
  "synopsis in help info" should "be part of manual" in {
    new File("docs/index.md") should containTrimmed(clo.synopsis)
  }

  "description line(s) in help info" should "be part of manual and pom.xml" in {
